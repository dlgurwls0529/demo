...
public class WriteAuthsGetResponseDto {
    ...
    private final String folderPrivateEWA;
    ...
    @Builder
    public WriteAuthsGetResponseDto(String folderCP, String folderPublicKey, String folderPrivateEWA, boolean isTitleOpen, String title, String symmetricKeyEWF, LocalDateTime lastChangedDate) {
        this.folderCP = folderCP;
        this.folderPublicKey = folderPublicKey;
        this.folderPrivateEWA = folderPrivateEWA;
